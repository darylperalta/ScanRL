...
class DDPG:
    ...
    def __init__(self,args, act_dim, env_dim, act_range, k, buffer_size = 20000, gamma = 0.99, lr = 0.00005, tau = 0.001):
        """ Initialization
        """
        # Environment and A2C parameters
        self.act_dim = act_dim
        self.act_range = act_range
        self.env_dim = env_dim + (k,)
        self.gamma = gamma
        self.lr = lr
    ...
    def train(self, env, args, summary_writer):
        ...
        for e in tqdm_e:
            ...
            noise = OrnsteinUhlenbeckProcess(size=self.act_dim, n_steps_annealing=1000)
    ...
    def save_weights(self, path, ep = 1000):
